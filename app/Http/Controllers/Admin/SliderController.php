...
class SliderController extends Controller
{
    ...
    public function store(SliderFormRequest $request)
    {
        ...
        if($request->hasFile('sub_image')){
            ...
            $filename = time().'.'.$ext;
            $file->move('uploads/slider/',$filename);
            $validatedData['sub_image'] = 'uploads/slider/'.$filename;
        }
        ...
        if($request->hasFile('mobile_slider_image')){
            ...
            $filename = time().'.'.$ext;
            $file->move('uploads/slider/',$filename);
            $validatedData['mobile_slider_image'] = 'uploads/slider/'.$filename;
        }
        ...
        Slider::create([
            ...
            'redirect_link' => $validatedData['redirect_link'],
            'button_text' => $validatedData['button_text'],
            'description' => $validatedData['description'],
            'image' => $validatedData['image'],
            'sub_image' => $validatedData['sub_image'],
            'mobile_slider_image' => $validatedData['mobile_slider_image'],
    ...
    public function update(SliderFormRequest $request, $id)
    {
        ...
        if($request->hasFile('sub_image')){
            ...
            $subdestination = $slider->sub_image;

            if(File::exists($subdestination)){
                File::delete($subdestination);
            }
        ...
        if($request->hasFile('mobile_slider_image')){
            $mobdestination = $slider->mobile_slider_image;
            if(File::exists($mobdestination)){
                File::delete($mobdestination);
            }
            $file = $request->file('mobile_slider_image');
            $ext = $file->getClientOriginalExtension();
            $filename = time().'.'.$ext;
        ...
        Slider::where('id', $slider->id)->update([
            ...
            'sub_image' => $validatedData['sub_image'] ?? $slider->sub_image,
            'mobile_slider_image' => $validatedData['mobile_slider_image'] ?? $slider->mobile_slider_image,
            'status' => $validatedData['status']
        ]);
