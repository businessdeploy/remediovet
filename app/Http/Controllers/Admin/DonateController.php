...
class DonateController extends Controller
{
    ...
    {
        $data = Donate::find(1);
        return view('admin.donate.edit', ['data' => $data]);
    }

    public function update(DonateFormRequest $request, $id = 1)
    {
        ...
        return redirect('/admin/donatepage')->with('message', 'Donate Page Updated Successfully!');
    }
