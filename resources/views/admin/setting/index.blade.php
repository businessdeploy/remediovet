@extends('layouts.admin',['layout'=>'Setting'])
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="website_url" value="{{ $setting->website_url ?? '' }}" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="phone" name="phone1" value="{{ $setting->phone1 ?? '' }}" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="">email Id 1* <span class="text-danger">*</span></label>
                            <input type="email" name="email1" value="{{ $setting->email1 ?? '' }}" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
