    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.order.list') }}" method="POST" class="order_filter">
                        @csrf
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="hold" {{ Request::get('status') == "hold" ? 'selected':''}}>Hold</option>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderd table-striped" id="form_datatable">
                            <thead>
                                <tr>
                                    <th>Order ID</th>
                                    <th>Tracking No</th>
                                ...
                                @forelse ($orders as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you sure to Delete?');" href="{{ route('admin.order.delete', [encrypt($item->id)]) }}" class="btn btn-danger btn-sm">Delete</a>
                                            @endif  
                                        </td>
                                    </tr>
                                @empty
